...
Question 1: Was the year-over-year change in public investment in lower-carbon energy RD&D significant during 
...
```{r cleaning up data set for analysis}
#Adding date column to US data frame and transforming it into date object. Also adding a column to denote pre or Obama era for graphing.
RDD.US.Eras <- RDD.US %>%
...
#Adding Date column to US and Germany dataframe. Formatting so that column is transformed to date class
